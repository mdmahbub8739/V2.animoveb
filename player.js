...
(function(global) {
    ...
    function buildAuroraUrl(ctx, opts = {}) {
        ...
        // Enforce Hindi ('hi') as the default fallback
        p.set('lang', opts.lang || opts.lan || 'hi');
    ...
    function buildPeachifyUrl(ctx, opts = {}) {
        ...
        // Enforce Hindi as the default fallback dub
        p.set('dub', opts.dub || 'Hindi');
    ...
    function buildScreenscapeUrl(ctx, opts = {}) {
        ...
        // Dynamically assign IMDB or TMDB depending on id format
        ...
        p.set('type', ctx.type); // 'movie' or 'tv'
        ...
        // Enforce 'hindi' as the baseline fallback language configuration
        let lang = opts.lan || opts.lang;
        if (!lang && opts.dub) {
            lang = opts.dub.toLowerCase() === 'hindi' ? 'hindi' : opts.dub;
        }
        p.set('lan', (lang || 'hindi').toLowerCase());
